...
static const char *up_vol[]   = { "amixer", "-c", "0", "set", "Master", "1dB+", "unmute", NULL };
static const char *down_vol[] = { "amixer", "-c", "0", "set", "Master", "1dB-", "unmute",  NULL };
static const char *mute_vol[] = { "amixer", "-c", "0", "set", "Master", "mute", NULL };
...
static const char col_green[]       = "#00d914";
static const char col_red[]         = "#d80000";
